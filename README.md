...
│   │   │   ├── text_renderer.py                  # Fills a .txt template; unused since both documents went binary
...
│   ├── make_rirekisho_template.py                # Blanks the approved 履歴書 sample into app/documents/templates/
